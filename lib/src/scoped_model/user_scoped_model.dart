...
import 'package:food/src/models/user_model.dart';
import 'package:food/src/enum/auth_mode.dart';
import 'package:food/src/models/user_model.dart';
  ...
  Future<bool> addUserInfo(Map<String, dynamic> userInfo) async {
    ...
    try {
      final http.Response response = await http.post(
          "https://food-delivery-8775e.firebaseio.com/users.json",
    ...
    try {
      ...
      if (authMode == AuthMode.SignUp) {
        response = await http.post(
          "https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyAjfjli127xT1_YhBnP2MDEG2Ixm3SwPNM",
          body: json.encode(authData),
          headers: {'Content-Type': 'application/json'},
        );
      } else if (authMode == AuthMode.SignIn) {
        response = await http.post(
          "https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyAjfjli127xT1_YhBnP2MDEG2Ixm3SwPNM",
          body: json.encode(authData),
          headers: {'Content-Type': 'application/json'},
        );
      }
